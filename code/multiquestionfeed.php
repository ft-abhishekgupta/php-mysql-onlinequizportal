                ...
                <div class="col-md-8" style="padding-right:40px ">
                  <div class="tab-content">
                      <div class="tab-pane <?php echo $active1;?>" id="tab1">
                        ...
                        <form name="typea" action="multiquestionfeed.php" method="post">
                      ...
                      <div class="tab-pane <?php echo $active2;?>" id="tab2">
                        <form name="typeb" action="multiquestionfeed.php" method="post">
                      ...
                      <div class="tab-pane <?php echo $active3;?>" id="tab3">
                        <form name="typec" action="multiquestionfeed.php" method="post">
                      ...
                      <div class="tab-pane <?php echo $active4;?>" id="tab4">
                        <form name="typed" action="multiquestionfeed.php" method="post">
                      ...
                      <div class="tab-pane <?php echo $active5;?>" id="tab5">
                        <form name="typee" action="multiquestionfeed.php" method="post">
                      ...
                      <div class="tab-pane <?php echo $active6;?>" id="tab6">
                        <form name="typef" action="multiquestionfeed.php" method="post">
